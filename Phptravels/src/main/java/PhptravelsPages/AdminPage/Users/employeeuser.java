...
public class employeeuser extends PageBase {
    public employeeuser(WebDriver driver) {
        super(driver);
    }
    By users=By.xpath("/html/body/main/header/ul/li[6]/button");
    By employeeusers=By.xpath("//*[@id=\"users-collapse\"]/ul/li[4]/a");
    ...
    public void clickemployeeusers(){clickOnElement(employeeusers);}
