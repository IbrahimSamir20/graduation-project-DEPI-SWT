...
public class TransferCars extends PageBase{
    ...
    By PickUpDay = By.xpath("(//*[@class=\"day \"][text()=4])[3]");
    ...
    By DropDay = By.xpath("(//*[@class=\"day \"][text()=4])[4]");
    ...
    By NumOfTravelersButton = By.xpath("(//*[@class=\"dropdown-toggle dropdown-btn travellers waves-effect\"])");
    By NumOfAdults = By.xpath("(//*[@class=\"qtyInput_cars\"])[1]");
    By NumOfChilds =By.xpath("(//*[@class=\"qtyInput_cars\"])[2]");
    public TransferCars(WebDriver driver) {
        super(driver);
    }
    public void clickCarsButton (){
        clickOnElement(CarsButton);
    }
//    public void FillFromAirport(String Airport){
//        sendKeys(FromAirport,Airport);
//    }
    ...
    public void ClickOnToLocation(String Value){
